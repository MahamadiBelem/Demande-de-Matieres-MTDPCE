...
import demande.matieres.repository.StructureRepository;
...
class StructureResourceIT {
    ...
    private static final String DEFAULT_LIBELLE_STRUCTURE = "AAAAAAAAAA";
    private static final String UPDATED_LIBELLE_STRUCTURE = "BBBBBBBBBB";
    ...
    public static Structure createEntity(EntityManager em) {
        Structure structure = new Structure().libelleStructure(DEFAULT_LIBELLE_STRUCTURE).codeStructure(DEFAULT_CODE_STRUCTURE);
        return structure;
    }
    ...
    public static Structure createUpdatedEntity(EntityManager em) {
        Structure structure = new Structure().libelleStructure(UPDATED_LIBELLE_STRUCTURE).codeStructure(UPDATED_CODE_STRUCTURE);
        return structure;
    }
    ...
    void createStructure() throws Exception {
        ...
        assertThat(testStructure.getLibelleStructure()).isEqualTo(DEFAULT_LIBELLE_STRUCTURE);
    ...
    @Test
    @Transactional
    void checkLibelleStructureIsRequired() throws Exception {
        int databaseSizeBeforeTest = structureRepository.findAll().size();
        // set the field null
        structure.setLibelleStructure(null);
    ...
    @Test
    @Transactional
    void checkCodeStructureIsRequired() throws Exception {
        int databaseSizeBeforeTest = structureRepository.findAll().size();
        // set the field null
        structure.setCodeStructure(null);
    ...
    void getAllStructures() throws Exception {
        ...
        restStructureMockMvc
            ...
            .andExpect(jsonPath("$.[*].libelleStructure").value(hasItem(DEFAULT_LIBELLE_STRUCTURE)))
    ...
    void getStructure() throws Exception {
        ...
        restStructureMockMvc
            ...
            .andExpect(jsonPath("$.libelleStructure").value(DEFAULT_LIBELLE_STRUCTURE))
    ...
    void putNewStructure() throws Exception {
        ...
        updatedStructure.libelleStructure(UPDATED_LIBELLE_STRUCTURE).codeStructure(UPDATED_CODE_STRUCTURE);
        ...
        Structure testStructure = structureList.get(structureList.size() - 1);
        assertThat(testStructure.getLibelleStructure()).isEqualTo(UPDATED_LIBELLE_STRUCTURE);
    ...
    void partialUpdateStructureWithPatch() throws Exception {
        ...
        partialUpdatedStructure.codeStructure(UPDATED_CODE_STRUCTURE);
    ...
    void fullUpdateStructureWithPatch() throws Exception {
        ...
        partialUpdatedStructure.libelleStructure(UPDATED_LIBELLE_STRUCTURE).codeStructure(UPDATED_CODE_STRUCTURE);
